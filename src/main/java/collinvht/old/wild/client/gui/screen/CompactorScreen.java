package collinvht.old.wild.client.gui.screen;
...
public class CompactorScreen extends ContainerScreen<CompactorContainer> {
    ...
    public CompactorScreen(CompactorContainer containerIn, PlayerInventory playerInv, ITextComponent titleIn) {
    ...
    protected void renderHoveredTooltip(MatrixStack matrixStack, int x, int y) {
        ...
        if (this.hasItemsInInputSlot) {
            ...
            List<CompactorRecipe> list = this.container.getRecipeList();
