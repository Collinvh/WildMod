...
public class CloudedLeopardRender extends LivingRenderer<CloudedLeopardEntity, CloudedLeopard<CloudedLeopardEntity>> {
    ...
    @Override
    protected boolean canRenderName(CloudedLeopardEntity entity) {
        return false;
    }
}
