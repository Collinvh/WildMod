 ...
 */
@OnlyIn(Dist.CLIENT)
public class BluePinguinModel<T extends BluePinguinEntity> extends AdvancedEntityModel<T>
{
    public final AdvancedModelBox body;
    public final AdvancedModelBox head;
    public final AdvancedModelBox leftfoot;
    public final AdvancedModelBox rightfoot;
    public final AdvancedModelBox leftweeng;
    public final AdvancedModelBox rightweeng;
    public final AdvancedModelBox beeeek;

    public BluePinguinModel()
    {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.leftweeng = new AdvancedModelBox(this, 0, 0);
        ...
        this.head = new AdvancedModelBox(this, 25, 22);
        ...
        this.rightweeng = new AdvancedModelBox(this, 11, 0);
        ...
        this.body = new AdvancedModelBox(this, 0, 16);
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(body, beeeek, leftfoot, leftweeng, rightfoot, rightweeng, head);
    }
