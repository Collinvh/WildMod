...
import collinvht.wild.entity.entities.goal.IceSkateGoal;
import collinvht.wild.entity.entities.goal.PinguinJumpGoal;
...
public class BluePinguinEntity extends AnimalEntity {
    ...
    public BluePinguinEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        ...
        this.moveController = new BluePinguinEntity.MoveHelperController(this);
        this.stepHeight = 1.0F;
    }

    public static AttributeModifierMap.MutableAttribute func_234204_eW_() {
        return MobEntity.func_233666_p_().createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.5F).createMutableAttribute(Attributes.ATTACK_DAMAGE, 6.0D);
    }
    ...
    protected PathNavigator createNavigator(World worldIn) {
        return new BluePinguinEntity.Navigator(this, worldIn);
    }
    ...
    public AgeableEntity func_241840_a(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        return EntityHandler.blue_pinguin.create(p_241840_1_);
    }
