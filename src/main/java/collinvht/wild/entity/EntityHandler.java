...
import collinvht.wild.client.renders.BluePinguinRender;
import collinvht.wild.client.renders.NurseSharkRender;
import collinvht.wild.client.renders.RedpandaRender;
...
public class EntityHandler {
    ...
    public static final EntityType<NurseSharkEntity> nurse_shark = EntityType.Builder.create(NurseSharkEntity::new, EntityClassification.AMBIENT).func_233608_b_(10).size(1.2F, 1F).trackingRange(8).setUpdateInterval(1).func_233608_b_(10).build("nurse_shark");
